  ...
  static get jsonSchema() {
    return {
      ...
      properties: {
        ...
        telefone_receita: { type: ['string', 'null'], maxLength: 32 },
        telefone_receita_contatavel: { type: ['boolean', 'integer', 'null'] },
        telefone_google: { type: ['string', 'null'], maxLength: 32 },
        telefone_google_contatavel: { type: ['boolean', 'integer', 'null'] },
