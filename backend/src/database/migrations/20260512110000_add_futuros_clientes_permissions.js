const PERMISSOES = [
  {
    ...
    descricao: 'Permite acessar a pagina de futuros clientes e ver mailing marcados como futuro cliente.'
  },
  {
    chave: 'futuros_clientes_registrar',
    nome: 'Futuros clientes: registrar',
    descricao: 'Permite marcar um registro de mailing recebido como futuro cliente com notas e data de retorno.'
  }
];
