...
const routeConfigs = [
  ...
  { path: '/clientes-secretos', title: 'Clientes próprios', sub: 'Registros próprios para rastrear novos clientes', id: 'clientes-secretos', end: true },
  { path: '/clientes-secretos/novo', title: 'Novo cliente próprio', sub: 'Cadastre um registro próprio de prospeccao', id: 'clientes-secretos' },
  { path: '/clientes-secretos/:id/editar', title: 'Editar cliente próprio', sub: 'Atualize seu registro próprio', id: 'clientes-secretos' },
